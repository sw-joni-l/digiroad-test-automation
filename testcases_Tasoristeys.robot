...
Tasoristeys 1
    ...
    KW_Tasoristeys.Tasoristeys_1  6712170,240460

Tasoristeys 2
    [Tags]              Tasoristeys  Mandatory  Sikuli
    [Documentation]     Rautatien tasoristeys, selain: ${BROWSER}
    ...  - Tarkistetaan olemassa olevaa Rautatien tasoristeystä - Formin id
    KW_Tasoristeys.Tasoristeys_2  6712203,240427

Tasoristeys 3
    [Tags]              Tasoristeys  Mandatory  Sikuli
    [Documentation]     Rautatien tasoristeys, selain: ${BROWSER}
    ...   - Rautatien tasoristeys muokkaus.
    KW_Tasoristeys.Tasoristeys_3  6714850,229269
...
Tasoristeys 4
    ...
    KW_Tasoristeys.Tasoristeys_4  6714598, 228242
